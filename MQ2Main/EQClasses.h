...
EQLIB_OBJECT CXStr::CXStr(void);
EQLIB_OBJECT void CXStr::operatorp(void)const;
//EQLIB_OBJECT void CXStr::operator char *(void)const;
...
EQLIB_OBJECT static int __cdecl CXWnd_DrawColoredRect(class CXRect,unsigned long);
...
EQLIB_OBJECT int * CXWnd::vector_deleting_destructor(bool);
...
EQLIB_OBJECT bool CXWnd::SetWindowTextA(class CXStr);
// protected
...
/*0x0128*/ CContextMenu *Menus[0x400];
...
EQLIB_OBJECT static int __cdecl CDisplay::WriteTextHD2(char const *,int,int,COLORREF,DWORD);
...
EQLIB_OBJECT struct S3D_STRINGSPRITE * CDisplay::t3dGetDagSprite(struct T3D_DAG *);
EQLIB_OBJECT struct S3D_STRINGSPRITE * CDisplay::ChangeBoneStringSprite(struct T3D_DAG *,struct T3D_DAG *,char *);
...
EQLIB_OBJECT int CContextMenu::AddMenuItem(class CXStr,DWORD,DWORD);
...
{
public:
CMapViewWnd::CMapViewWnd(class CXWnd *);
...
EQLIB_OBJECT void CMapViewWnd::SetCurrentZone(enum EQZoneIndex,struct T3D_XYZ *,struct T3D_XYZ *);
// virtual
...
EQLIB_OBJECT class CTextureFont * CXWndManager::GetFont1(int)const;
...
EQLIB_OBJECT bool EQ_LoadingS::WriteTextHD(char *,int,int,int,int);
// virtual
...
EQLIB_OBJECT bool EQPlayer::SetNameSpriteTint(PSPAWNINFO pSpawn);
...
EQLIB_OBJECT bool EQPlayer::SetNameSpriteState(PSPAWNINFO,bool);
...
//EQLIB_OBJECT struct S3D_STRINGSPRITE * EQPlayer::ChangeBoneStringSprite(struct T3D_DAG *,struct T3D_DAG *,char *);
...
EQLIB_OBJECT char * __cdecl EQUtil::build_token_string_PARAM(char *,int,char *,char *,char *,char *,char *,char *,char *,char *,char *);
};
...
EQLIB_OBJECT bool EQWorldData::GetGeometryNameFromIndex(enum EQZoneIndex,char *)const;
EQLIB_OBJECT bool EQWorldData::IsFlagSet(EQZoneIndex,unsigned long)const;
EQLIB_OBJECT bool EQWorldData::IsNewbieZone(enum EQZoneIndex)const;
...
inline EQLIB_OBJECT KeyCombo::KeyCombo(unsigned __int32 keycode)
{	
	Data[0]=LOBYTE(LOWORD(keycode));
	Data[1]=HIBYTE(LOWORD(keycode));
	Data[2]=LOBYTE(HIWORD(keycode));
	Data[3]=HIBYTE(HIWORD(keycode));
}
...
inline EQLIB_OBJECT bool KeyCombo::UsesCombo(void)const
{
	return (Data[0]!=0);
}
EQLIB_OBJECT class CXStr KeyCombo::GetTextDescription(void)const;
inline EQLIB_OBJECT class KeyCombo const & KeyCombo::operator=(unsigned __int32 keycode)
{
	this->Data[0]=LOBYTE(LOWORD(keycode));
	this->Data[1]=HIBYTE(LOWORD(keycode));
	this->Data[2]=LOBYTE(HIWORD(keycode));
	this->Data[3]=HIBYTE(HIWORD(keycode));
	return *this;
}
...
EQLIB_OBJECT bool KeypressHandler::HandleKeyDown(int,int);
EQLIB_OBJECT bool KeypressHandler::HandleKeyUp(int);
...
/*0x000*/   class KeyCombo NormalKey[0x100];//0x400 bytes
/*0x400*/   class KeyCombo AltKey[0x100];//0x400 bytes
/*0x800*/
...
/*0x1a8*0x00*/ FLOAT _00_ZoneLeftExtent;
/*0x1ac*0x04*/ FLOAT _04_ZoneTopExtent;
/*0x1b0*0x08*/ FLOAT _08_ZoneRightExtent;
/*0x1b4*0x0c*/ FLOAT _0C_ZoneBottomExtent;
/*0x1b8*0x10*/ FLOAT _10_MapWidth;
/*0x1bc*0x14*/ FLOAT _14_MapHeight;
/*0x1c0*0x18*/ FLOAT _18_Unknown;
/*0x1c4*0x1c*/ FLOAT _1C_Unknown;
/*0x1c8*0x20*/ DWORD _20_1c8_Unknown;
/*0x1cc*0x24*/ DWORD _24_1cc_Unknown;
/*0x1d0*0x28*/ BYTE  _28_Unknown[0x18];
/*0x1e8*0x40*/ PMAPLINE pLines;//not correct
/*0x1ec*0x44*/ PMAPLABEL pLabels;//but gotta put somewhere to compile
/*0x1f0*0x48*/ BYTE  _48_Unknown[0x10];
/*0x200*0x58*/ BYTE  _58_Unknown;
/*0x201*0x59*/ BYTE  _59_Unknown;
/*0x202*0x5a*/ BYTE  _5a_Unknown;
/*0x203*0x5b*/ BYTE  _5b_Unknown;
/*0x204*0x5c*/ DWORD _5c_Unknown;
/*0x208*0x60*/ DWORD _60_Unknown;
/*0x20C*0x64*/ DWORD _64_Unknown;
/*0x210*0x68*/ DWORD _68_Unknown;
/*0x214*0x6c*/ DWORD _6c_MinZ;
/*0x218*0x70*/ DWORD _70_MaxZ;
/*0x21c*0x74*/ bool  _74_MVW_ZFilterButtonChecked;
/*0x21d*0x75*/ BYTE  _75_Unknown;
/*0x21e*0x76*/ BYTE  _76_Unknown;
/*0x21f*0x77*/ BYTE	 _77_Unknown;
/*0x220*0x78*/ FLOAT _78_Unknown;
/*0x224*0x7c*/ FLOAT _7C_Unknown;
/*0x228*0x80*/ bool  _80_MVW_LabelsToggleButtonChecked;
/*0x229*0x81*/ BYTE  _81_Unknown;
/*0x22a*0x82*/ BYTE  _82_Unknown;
/*0x22b*0x83*/ BYTE  _83_Unknown;
/*0x22c*0x84*/
};
