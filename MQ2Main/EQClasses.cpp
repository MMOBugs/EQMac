...
FUNCTION_AT_VIRTUAL_ADDRESS(int *CXWnd::vector_deleting_destructor(bool),0x04);
...
FUNCTION_AT_VIRTUAL_ADDRESS(void CXWnd::Deactivate(void),0x88);
FUNCTION_AT_VIRTUAL_ADDRESS(int CXWnd::OnResize(int,int),0x094);
//FUNCTION_AT_VIRTUAL_ADDRESS(int CXWnd::Show(bool,bool),0x08c);
FUNCTION_AT_VIRTUAL_ADDRESS(int CXWnd::SetVScrollPos(int),0xF0);
FUNCTION_AT_VIRTUAL_ADDRESS(void CXWnd::SetDrawTemplate(class CXWndDrawTemplate *),0xe8);
FUNCTION_AT_VIRTUAL_ADDRESS(bool CXWnd::SetWindowTextA(class CXStr),0xec);
FUNCTION_AT_VIRTUAL_ADDRESS(class CXRect CXWnd::GetClientRect(void)const,0xd8);
...
//CComboWnd__DeleteAll
FUNCTION_AT_VIRTUAL_ADDRESS(void CListWnd::DeleteAll(void),0x114);
...
#endif
#ifdef CContextMenu__dCContextMenu
...
FUNCTION_AT_ADDRESS(int  CContextMenu::AddMenuItem(class CXStr,DWORD,DWORD),CContextMenu__AddMenuItem);
#endif
...
#endif
FUNCTION_AT_VARIABLE_ADDRESS(struct S3D_STRINGSPRITE * CDisplay::t3dGetDagSprite(struct T3D_DAG *actor),0x7F99FC);
...
FUNCTION_AT_ADDRESS(int __cdecl CDisplay::WriteTextHD2(char const *,int,int,COLORREF,DWORD),CDisplay__WriteTextHD2);
#endif
...
FUNCTION_AT_ADDRESS(class CTextureFont *  CXWndManager::GetFont1(int)const ,CXWndManager__GetFont1);
#endif
...
FUNCTION_AT_ADDRESS(unsigned char  EQ_Character::CastSpell(unsigned char,int,class EQ_Item **,int),EQ_Character__CastSpell);
#endif
...
FUNCTION_AT_ADDRESS(bool  EQ_LoadingS::WriteTextHD(char *,int,int,int,int),EQ_LoadingS__WriteTextHD);
#endif
...
FUNCTION_AT_ADDRESS(bool  EQPlayer::SetNameSpriteState(PSPAWNINFO,bool),EQPlayer__SetNameSpriteState);
#endif
//first arg is edi+288
//second is [pinstCDisplay+2E08h]
//third arg is the string for sure!
#ifdef EQPlayer__ChangeBoneStringSprite
FUNCTION_AT_ADDRESS(struct S3D_STRINGSPRITE *  CDisplay::ChangeBoneStringSprite(struct T3D_DAG *,struct T3D_DAG *,char *),EQPlayer__ChangeBoneStringSprite);
#endif
#ifdef EQPlayer__SetNameSpriteTint
FUNCTION_AT_ADDRESS(bool  EQPlayer::SetNameSpriteTint(PSPAWNINFO),EQPlayer__SetNameSpriteTint);
#endif
...
#endif
#ifdef EQUtil__build_token_string_PARAM
FUNCTION_AT_ADDRESS(char * __cdecl EQUtil::build_token_string_PARAM(char *,int,char *,char *,char *,char *,char *,char *,char *,char *,char *),EQUtil__build_token_string_PARAM);
#endif
...
FUNCTION_AT_ADDRESS(bool  KeypressHandler::HandleKeyDown(int,int),KeypressHandler__HandleKeyDown);
#endif
#ifdef KeypressHandler__HandleKeyUp
FUNCTION_AT_ADDRESS(bool  KeypressHandler::HandleKeyUp(int),KeypressHandler__HandleKeyUp);
#endif
...
#endif
#ifdef CXWnd__OnProcessFrame
FUNCTION_AT_ADDRESS(int CXWnd::OnProcessFrame(void),CXWnd__OnProcessFrame);
#endif
#ifdef CXWnd__IsType
...
#endif
#ifdef CXWnd__DrawColoredRect1
FUNCTION_AT_ADDRESS(int __cdecl CXWnd::CXWnd_DrawColoredRect(class CXRect,unsigned long),CXWnd__DrawColoredRect1);
#endif
...
FUNCTION_AT_ADDRESS(void CXStr::operatorp(void)const ,CXStr__operator_char_p);
#endif
...
#endif
#ifdef CListWnd__WndNotification
FUNCTION_AT_ADDRESS(int  CListWnd::WndNotification(class CXWnd *,unsigned __int32,void *),CListWnd__WndNotification);
#endif
