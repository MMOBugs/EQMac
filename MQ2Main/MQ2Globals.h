...
{
EQLIB_OBJECT PCHAR _NewUIINI(void);
EQLIB_OBJECT void SaveToUIIniFile(PCHAR Section,PCHAR Key,PCHAR Value);
EQLIB_OBJECT void LoadStringFromUIIniFile(char *,char *,char *,char *,int);
...
EQLIB_API DWORD bmPluginsDamaged;
...
/* OTHER */
EQLIB_API BOOL bExeChecksumrequested;
...
EQLIB_VAR DWORD DrawHUDParams[10];
...
EQLIB_VAR CCustomMenu *CategoryMenu;
EQLIB_VAR int gSpellMenuIndex;
...
EQLIB_VAR PWORD EQADDR_DOABILITYLIST;
...
EQLIB_VAR MQRANK EQP_DistArray[5000];
